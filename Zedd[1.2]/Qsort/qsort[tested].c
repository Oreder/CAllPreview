...
This example contains three separate functions sort_integers_example(), sort_cstrings_example() and sort_structs_example().
	1) sort_integers_example() uses int_cmp() as compar callback. Additional function print_int_array is used for printing integer array contents.
	2) sort_cstrings_example() uses cstring_cmp() as compar callback. Additional function print_cstring_array is used for printing string array contents.
	3) sort_structs_example() uses struct_cmp_by_price() and struct_cmp_by_product() as compar callbacks. Additional function print_struct_array is used for printing array of struct.
...
Source: http://www.anyexample.com/programming/c/qsort__sorting_array_of_strings__integers_and_structs.xml
*/